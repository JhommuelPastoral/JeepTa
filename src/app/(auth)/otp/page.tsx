    ...
    <div className="flex flex-col items-center justify-center w-screen min-h-screen gap-2 px-2 font-poppins">
      ...
      <div >
        ...
        <p className="text-sm leading-5 tracking-tighter text-center text-gray-500">
          Please enter the verification code sent to <span className="font-semibold underline underline-offset-4">{email}</span> to sign up to get started with JeepTa
        </p>
      </div>
      ...
      <div className="flex items-center justify-center w-full">
        ...
        <Button variant="link" className="underline cursor-pointer hover:text-blue-400" disabled onClick={onResendOTP}> Resend</Button>
      </div>
